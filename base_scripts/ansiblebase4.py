...
shell.send('sudo -i\n')
time.sleep(1)
shell.send("ansible ****switchname**** -m raw -a 'show version | i uptime' -u ******** -k\n")
time.sleep(1)
shell.send('*****password*****\n')
time.sleep(1)
...
stdin, stdout, stderr = ssh_client.exec_command("ansible ****switchname**** -m raw -a 'show version | i uptime' -u ******** -k\n")
stdin.write("**********\n")
time.sleep(2)
